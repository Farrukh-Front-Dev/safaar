...
export class InMemoryDbService {
  ...
  readonly hotels: HotelRecord[] = [
    ...
    {
      id: 'hotel-grand-bukhara',
      partner_organization_id: 'demo-partner-org-id',
      slug: 'grand-bukhara',
      city_id: 'city-bukhara',
      name: {
      ...
      description: {
        uz: 'Buxoro eski shahar markazidagi hashamatli hotel.',
        ru: 'Роскошный отель в центре старого Бухары.',
        en: 'Luxury hotel in the heart of old Bukhara.',
      },
      address: 'Buxoro, Haqiqat ko\'chasi 25',
      latitude: 39.7747,
      longitude: 64.4286,
      stars: 4,
      rating_average: 4.5,
      ...
      images: ['/public/hotels/grand-bukhara.jpg'],
      check_in_time: '14:00',
      check_out_time: '12:00',
    },
    {
      id: 'hotel-tashkent-palace',
      partner_organization_id: 'demo-partner-org-id',
      slug: 'tashkent-palace',
      city_id: 'city-tashkent',
      name: {
      ...
      description: {
        uz: 'Toshkent markazidagi zamonaviy 5 yulduzli hotel.',
        ru: 'Современный 5-звездочный отель в центре Ташкента.',
        en: 'Modern 5-star hotel in downtown Tashkent.',
      },
      address: 'Toshkent, Amir Temur shoh ko\'chasi 5',
      latitude: 41.3111,
      longitude: 69.2797,
      stars: 5,
      rating_average: 4.8,
      ...
      images: ['/public/hotels/tashkent-palace.jpg'],
      check_in_time: '15:00',
      check_out_time: '12:00',
    },
  ];
