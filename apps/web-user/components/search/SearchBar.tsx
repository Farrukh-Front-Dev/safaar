 ...
 * Airbnb uslubidagi ulangan "pill" layout: har maydon ikon bilan, ajratuvchi
 * chiziqlar bilan birlashgan. Mobil'da vertikal stacked.
 */
...
/* ── Maydon konteyneri: ikon + label + control ── */
function Field({
  icon,
  label,
  children,
...
/* ── Shahar tanlash — pill option'li custom dropdown ── */
function CityPicker({
  cities,
  value,
  onChange,
  ...
  return (
    <div ref={ref} className="relative flex-1 md:flex-[1.5]">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
